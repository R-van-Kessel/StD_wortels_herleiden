...
function generateQuestions() {
    ...
    //let optellenPool = [
        ...
        { text: '4√7 - √7',    answer: '3√7' },
        { text: '√2 + 5√2',    answer: '6√2' },
        { text: '6√3 - 4√3',   answer: '2√3' },
        { text: '3√6 + 2√6',   answer: '5√6' },
        { text: '8√5 - 3√5',   answer: '5√5' },
    ];
    ...
    // Type 4: Eenvoudige kwadraatwortels
    let eenvoudigPool = [
        { text: '√4',    answer: '2'  },
        { text: '√9',    answer: '3'  },
        { text: '√16',   answer: '4'  },
    ...
    // Shuffle elke pool
    simplifyPool  = shuffle(simplifyPool);
    optellenPool  = shuffle(optellenPool);
    productPool   = shuffle(productPool);
    eenvoudigPool = shuffle(eenvoudigPool);

    // Kies verdeling: 5 vereenvoudigen, 2 optellen, 2 product, 1 eenvoudig
    let selected = [
        ...simplifyPool.slice(0, 5),
        ...optellenPool.slice(0, 2),
        ...productPool.slice(0, 2),
        ...eenvoudigPool.slice(0, 1),
    ];

    // Shuffle de uiteindelijke selectie voor willekeurige volgorde
